...
- **Botón SOS:** flotante, siempre visible durante `en_curso`, alto contraste, requiere confirmación de un solo tap extra (evitar disparos accidentales pero sin fricción excesiva).
